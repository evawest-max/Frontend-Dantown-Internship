...
const ChatBox = () => {
    const messages = [
        { name: "Ironmen", text: "When will the event be held?", newMessage: "2", photo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBwgu1A5zgPSvfE83nurkuzNEoXs9DMNr8Ww&s" },
                ...
                <Box mr="40px" w="164px" h="50px" display="flex" flexDirection="row" justifyContent="space-between" alignItems="center">
                    ...
                    <Menu>
                        <MenuButton as={Text} weight="800px" size="16px" lineHeight="21.86px" color=" #0F3F62" display="flex" flexDirection="row" alignItems="center">
                            ...
                            <Text>Jamet Roy</Text> <ChevronDownIcon />
                        </MenuButton>
                        <MenuList>
